...
const load = async function () {
  ...
  try {
    images = import.meta.glob(
      '~/application/shared/assets/images/**/*.{jpeg,jpg,png,tiff,webp,gif,svg,JPEG,JPG,PNG,TIFF,WEBP,GIF,SVG}',
    );
  } catch (e) {
...
export const findImage = async (
  ...
  if (!imagePath.startsWith('~/application/shared/assets/images')) {
    return imagePath;
  }
