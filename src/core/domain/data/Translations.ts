...
export enum TranslationKeys {
  ...
  apps_terminal_commands_apps_maximized = "apps_terminal_commands_apps_maximized",
  ...
  apps_terminal_page_desc = "apps_terminal_page_desc",
  ...
  apps_welcome_about_me_page_desc = "apps_welcome_about_me_page_desc",
  apps_welcome_about_me_profile_image_alt = "apps_welcome_about_me_profile_image_alt",
  ...
  apps_welcome_contact = "apps_welcome_contact",
  apps_welcome_contact_desc = "apps_welcome_contact_desc",
  ...
  common_development = "common_development",
  ...
  common_programming = "common_programming",
  ...
  common_target_directory = "common_target_directory",
  common_technology = "common_technology",
  ...
  curriculum_vitae_computer_engineer = "curriculum_vitae_computer_engineer",
  ...
  system_rebooting = "system_rebooting",
  system_rebooting_desc = "system_rebooting_desc",
...
In 2022, my internship at [**Kodlama.io**](https://github.com/kodlamaio-projects) marked a significant turning point in my career. During and after the internship, I took my first steps into the workforce while continuing my education. I worked as a **Software Engineer & Instructor** for over 2 years, developing scalable enterprise applications for prominent organizations such as **BOSCH**, **Devlet Su İşleri**, and **ETIYA** using **.NET Core**, **Angular**, and **C#**. I also contributed as a core developer to the **NArchitecture Framework** and provided corporate training on **Clean Architecture**, **CQRS**, and modern development practices. In 2023, I graduated as a **Computer Engineer** with a **3.70 GPA** out of 4, ranking second in my faculty.

Currently, I am based in **Antalya** and primarily work with **.NET Core**, **Angular**, and **C#**, with a special interest in **CQRS**, **Microservices**, and modern software architectures. My approach to technology is driven by a constant **desire to learn**, inspiring me to discover new things every day. Sharing what I've learned on this journey, reaching more people, and contributing to the **software world** is my ultimate goal. In my software engineering process, I place great emphasis on software quality, adopting **Clean Architecture** principles and various **software philosophies, principles**, and **quality criteria**, which form the foundation of my work. I believe that success in the software world is not only possible through technological knowledge but also through good software practices and quality awareness.`,
...
2022 yılında [**Kodlama.io**](https://github.com/kodlamaio-projects)'da başladığım staj, kariyerimde önemli bir dönüm noktasıydı. Staj döneminde ve sonrasında eğitimimle paralel olarak iş hayatına adım attım. 2 yıldan fazla **Yazılım Mühendisi & Eğitmeni** olarak çalışarak, **BOSCH**, **Devlet Su İşleri** ve **ETIYA** gibi önemli kuruluşlar için **.NET Core**, **Angular** ve **C#** kullanarak ölçeklenebilir kurumsal uygulamalar geliştirdim. Aynı zamanda **NArchitecture Framework**'ün ana geliştiricilerinden biri olarak katkıda bulundum ve **Clean Architecture**, **CQRS** ve modern geliştirme pratikleri konularında kurumsal eğitimler verdim. 2023 yılında **bilgisayar mühendisi** olarak **4 üzerinden 3.70** not ortalamasıyla, **fakülte ikincisi** olarak mezun oldum.

Şu anda **Antalya**'da yaşıyorum ve başlıca **.NET Core**, **Angular** ve **C#** teknolojileriyle çalışıyor, ayrıca **CQRS**, **Microservices** ve modern yazılım mimarilerine özel ilgi duyuyorum. Teknolojiye olan **tutumum**, sürekli olarak **öğrenme isteğim**le birleşiyor ve her gün yeni şeyler keşfetmek için bana ilham veriyor. Bu yolculukta öğrendiklerimi paylaşmak, daha fazla insana dokunmak ve **yazılım dünyasına katkı sağlamak** en büyük hedefim. Yazılım geliştirme sürecimde, özellikle **Clean Architecture** prensiplerini benimseyerek yazılım kalitesine büyük önem veriyorum ve çeşitli **yazılım felsefeleri, prensipleri** ve **kalite kriterlerini** uygulamaya özen gösteriyorum. Yazılım dünyasında başarılı olmanın, sadece teknolojik bilgiyle değil, aynı zamanda iyi bir yazılım pratiği ve kalite bilinciyle mümkün olduğuna inanıyorum.`,
  },
